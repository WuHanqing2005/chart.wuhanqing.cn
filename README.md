...
### 📆 2026年更新日志
- **06-19 18:00(KST)**：
  - 新增全部公开的 `EAIP2026-07.V1.3_Web` 全中国EAIP航图
  - 将航图PDF文件存储位置改为`Cloudflare R2存储桶`，加快航图加载速度。
  - 去除航图显示区对`当前打开的PDF文件路径`的调试信息显示，增大航图实际显示面积。
  - 将网站背景图片由本地文件改为`在线图片链接`，提升页面加载性能。
- **06-28 01:00(KST)**：
  为解决手机端无法加载航图的问题，回退至`2026.06.19`版本<br>
